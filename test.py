...
async def main(board) -> None:
  transport, engine = await chess.engine.popen_uci(r"C:\Users\Nathan\Desktop\stockfish_14.1_win_x64_avx2\stockfish_14.1_win_x64_avx2\stockfish_14.1_win_x64_avx2.exe")
  print(board)
  k = 0
