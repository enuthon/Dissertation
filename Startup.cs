...
public class Startup : MonoBehaviour { 
  ...
  public static string[,] positions = new string[8, 8]
    {
        {"Left White Hook", "Left White Knight", "Left White Bishop", "White Queen", "White King", "Right White Bishop", "Right White Knight", "Right White Rook"},
        {"White Pawn", "White Pawn (1)","White Pawn (2)","White Pawn (3)","White Pawn (4)","White Pawn (5)","White Pawn (6)","White Pawn (7)"},
        {"","","","","","","",""},
        {"","","","","","","",""},
        {"","","","","","","",""},
        {"","","","","","","",""},
        {"Black Pawn", "Black Pawn (1)","Black Pawn (2)","Black Pawn (3)","Black Pawn (4)","Black Pawn (5)","Black Pawn (6)","Black Pawn (7)"},
        {"Right Black Hook", "Right Black Knight", "Right Black Bishop", "Black Queen", "Black King", "Left Black Bishop", "Left Black Knight", "Left Black Rook"}
    };
